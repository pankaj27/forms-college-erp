...
const ForgotUsernamePage: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        setSuccessMessage('');
        try {
            const response = await axios.post('/api/applicants/forgot-username', {
                email,
                captcha,
            });
            if (response.data.success) {
                setSuccessMessage('Your username has been sent to your registered email address.');
                setEmail('');
                setCaptcha('');
            }
        } catch (err: any) {
                ...
                <div className="max-w-6xl mx-auto px-4 py-6">
                    <div className="bg-white border border-gray-200 rounded shadow-sm max-w-2xl mx-auto">
                        ...
                        <div className="p-4 space-y-4 text-sm">
                            <p>
                                Enter your registered email address below, click on the <span className="font-semibold">Send</span>{' '}
                                button, and we will send your username to your email.
                            </p>
