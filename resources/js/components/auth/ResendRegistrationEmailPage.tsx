...
const ResendRegistrationEmailPage: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        setSuccessMessage('');
        try {
            const response = await axios.post('/api/applicants/resend-registration-email', {
                email,
                captcha,
            });
            if (response.data.success) {
                setSuccessMessage(
                    'Registration confirmation email has been resent to your registered email address.'
                );
                setEmail('');
                setCaptcha('');
            }
                    ...
                    <div className="bg-white border border-gray-200 rounded shadow-sm max-w-2xl mx-auto">
                        ...
                        <div className="p-4 space-y-4 text-sm">
                            <p className="text-[#b91c1c] font-semibold">
                                Can&apos;t find the email we sent to you? We can resend the email to you to complete the
                                registration.
                            </p>
                            <p>
                                Just enter the email address you signed up with, click the{' '}
                                <span className="font-semibold">Resend</span> button, and check your inbox again. It may
                                take a few moments for the email to arrive.
                            </p>
                            <p className="text-xs text-[#b91c1c]">
                                Note: Please check your spam folder if the confirmation email is not found in your inbox.
                            </p>
...
export default ResendRegistrationEmailPage;
